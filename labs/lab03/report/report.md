...
1. Открываем подготовленный файл .qmd, меняем в нем имя, фамилию автора, изменяем название, добавляем данные автора. (рис. @fig:001).

![Начало заполнения отчета](image/1.jpg){#fig:001width=70%}

2. Записывем цель работы, задание, теоретическое введение. (рис. @fig:002).

![Цель, задание, теоретическое введение](image/2.jpg){#fig:002 width=70%}
...
![Заполнение части "Выполнение лабораторной работы"](image/3.jpg){#fig:003 width=70%}

4.  Прописываем вывод. (рис. @fig:004).

![Заполнение части "Выводы"](image/4.jpg){#fig:004 width=70%}

5. С помощью команды pandoc создаем отчет в форматах .docx и .pdf. (рис. @fig:005).

![Команда pandoc](image/5.jpg){#fig:005 width=70%}
